...
<div class="row">
        <h3 class="header left teal-text">PERMISO PARA ACTIVIDADES FUERA DEL AULA</h3>
           ...
           <div class = "row">
           <h5 class="header left teal-text">Documentación Adjuntada:</h5>
           </div>
           <div class = "row">
                ...
                $ficheroDao=new FicheroDAO();
                    ...
                    ?>
                    <button class='waves-effect waves-light btn red lighten-1' type='submit' value='<?php  echo ($f->getNombre());?>' name='fichero'><?php  echo ($f->getNombre());?></button>
                  <?php
                    }
                ?>
                </form>
